...
require filepath + 'canvas/png_encoding'
require filepath + 'canvas/png_decoding'
require filepath + 'canvas/adam7_interlacing'
require filepath + 'canvas/stream_exporting'
require filepath + 'canvas/stream_importing'
require filepath + 'canvas/data_url_exporting'
require filepath + 'canvas/data_url_importing'
require filepath + 'canvas/operations'
require filepath + 'canvas/drawing'
